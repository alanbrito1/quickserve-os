...
BIGINT UNSIGNED en MySQL modo estricto cuando vida_util_meses es TINYINT.</span></div>
        ...
        <div class="section" id="localizacion">
            ...
            <p>En modo <strong>Interno</strong>, cada venta tiene un <strong>comprobante/recibo imprimible</strong>: en <strong>Ventas &rarr; Historial</strong>, el botón de recibo (💲) de cada venta abre <code>ventas/comprobante.php</code> con el número (INT-000123), los ítems, el total en la moneda del país y —si el IVA está activo— el desglose de base + impuesto, listo para imprimir. El modo <strong>Legal</strong> reemplazará ese comprobante por la factura electrónica del país cuando se integre su PAC (misma pantalla, driver distinto).</p>
