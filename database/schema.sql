-- ============================================================
-- QuickServe OS v6.1 — Esquema de instalación completo
...
-- ============================================================
-- INSTALACIÓN RECOMENDADA: usa el instalador web en /install/ — te pide las
-- credenciales de la base de datos, crea las tablas con este script, y registra
-- tu negocio y tu usuario administrador sin tocar SQL a mano.
--
-- INSTALACIÓN MANUAL (phpMyAdmin), como alternativa:
--   1. Crear la base de datos con CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
--      (el nombre lo eliges tú; en cPanel se crea desde "MySQL Databases").
--   2. Seleccionar esa base de datos y ejecutar este script completo.
--   3. (Opcional) Ejecutar database/sample_data.sql para cargar datos de ejemplo.
--   4. Entrar con el superadmin por defecto (admin@quickserve.local / Admin2026!)
--      y CAMBIAR LA CONTRASEÑA de inmediato en el primer login.
--
-- NOTA: Este script incluye TODAS las tablas, triggers y datos base (config,
--       catálogos, parámetros laborales, plan de cuentas y el superadmin). Los
--       datos de ejemplo (productos/insumos de muestra) están en sample_data.sql.
--       No es necesario ejecutar las migraciones 002-046 para una instalación nueva.
...
('nombre_negocio',    'Mi Negocio',                           'Nombre del negocio'),
...
-- Este esquema NO siembra productos/insumos/recetas: una instalación limpia
-- arranca con el catálogo vacío para que cada negocio arme el suyo.
-- ¿Quieres datos de muestra genéricos para explorar el sistema? Ejecuta
-- database/sample_data.sql (o marca "Cargar datos de ejemplo" en el instalador).
